...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><i class="fa fa-user fa-group"></i> SubMódulo </h1>
    </div>
</div>
...
<div id="div-registro" class="row hidden" >
    <form save action="servidor/sAdministracion.php" role="submodulo">
        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <span class = "input-group-btn">
                                <button class = "btn btn-default" type="button" data-toggle="modal" data-target="#modal-find" data-ajax="loadModulo">
                                    <i class="fa fa-search"></i> 
                                </button>
                                <button new class="btn btn-default" type="button" data-toggle="modal" data-target="#modal-new" data-url="mvc/views/Administracion/modulo.php">
...
<script type="text/javascript" src="recursos/views/Administracion/submodulo.js"></script>
