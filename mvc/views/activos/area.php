...
<div class="row" name="title">
    <div class="col-lg-12">
        <h1 class="page-header"><i class="fa fa-user fa-group"></i> Área </h1>
    </div>
</div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input id_find name="IDDepartamento" type="text" class="hidden" required>
                            <input descripcion_find type="text" class="form-control" aria-describedby="basic-addon1" readonly>
                            <span class = "input-group-btn">
                                <button class = "btn btn-default" type="button" data-toggle="modal" data-target="#modal-find" data-ajax="loadDepartamento">
                                    <i class="fa fa-search"></i> 
                                </button>
                                <button class = "btn btn-default" type="button" data-toggle="modal" data-target="#modal-new" data-url="mvc/views/activos/departamento.php">
...
<script type="text/javascript" src="recursos/views/Activos/area.js"></script>