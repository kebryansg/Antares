...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><i class="fa fa-user fa-group"></i> SubTipo General </h1>
    </div>
</div>
...
<script type="text/javascript" src="recursos/views/Activos/subtiposgeneral.js"></script>