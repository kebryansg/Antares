...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><i class="fa fa-user fa-group"></i> Tipo Emisor </h1>
    </div>
</div>
...
<div id="div-registro" class="row hidden" >
    <form role="TipoEmisor" action="servidor/sCatalogo.php" save>
        <div class="col-md-6">
...
<script type="text/javascript" src="recursos/views/Activos/tipoemisor.js"></script>