...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><i class="fa fa-user fa-group"></i> Bodega </h1>
    </div>
</div>
...
<div id="div-registro" class="row hidden" >
    <form save role="bodega" action="servidor/sCatalogo.php">
        <div class="col-md-6">
...
<script type="text/javascript" src="recursos/views/Activos/bodega.js"></script>