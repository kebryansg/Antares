...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><i class="fa fa-user fa-group"></i> País </h1>
    </div>
</div>
...
<div id="div-registro" class="row hidden" >
    <form role="pais" action="servidor/sCatalogo.php" save>
        <div class="col-md-6">
...
<script type="text/javascript" src="recursos/views/Activos/pais.js"></script>
